<script lang="ts">
    import "$lib/css/sb.css";
    import "$lib/css/markdown.css";
    import appJsonData from "../../app.json"
    import { Layout,appJsonDataStore,appStore } from "$lib/index.js";
...
{#snippet Logo()}
    <a href="/" class="logo" aria-label="Navigate to home page">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 107 128">
            <path d="M94.1566,22.8189c-10.4-14.8851-30.94-19.2971-45.7914-9.8348L22.2825,29.6078A29.9234,29.9234,0,0,0,8.7639,49.6506a31.5136,31.5136,0,0,0,3.1076,20.2318A30.0061,30.0061,0,0,0,7.3953,81.0653a31.8886,31.8886,0,0,0,5.4473,24.1157c10.4022,14.8865,30.9423,19.2966,45.7914,9.8348L84.7167,98.3921A29.9177,29.9177,0,0,0,98.2353,78.3493,31.5263,31.5263,0,0,0,95.13,58.117a30,30,0,0,0,4.4743-11.1824,31.88,31.88,0,0,0-5.4473-24.1157" fill="var(--sb-main-color,red)"/>
